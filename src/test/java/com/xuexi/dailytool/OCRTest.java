...
//        images.add("D:\\logo.jpg");
//        // Recognize images
//        ArrayList<RecognitionResult> results = api.Recognize(images, recognitionSettings);
//        results.forEach((result) -> {
//            System.out.println(result.recognitionText);
//        });
//        results.get(0).save("D:\\result.txt", Format.Text); // 可用
////        results.get(0).save("D:\\result.pdf", Format.Pdf); //  todo 异常：Can't create document
////        results.get(0).save("D:\\result2.pdf", Format.PdfNoImg); //  todo 异常：Can't create document
//        AsposeOCR.SaveMultipageDocument("D:\\result.pdf", Format.Pdf, results); //  todo 异常：Can't create document
//    }
//
//
//    /**
...
//            ClassPool.getDefault().insertClassPath("D:\\aspose-ocr-23.10.0.jar");
//            // 获取指定的class文件对象
