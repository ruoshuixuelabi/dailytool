...
public class WordsTest {
    ...
    public void doc2pdf_test() throws Exception {
        ...
        String sourceFile = "D:\\动态分析业务紧缩目前的逻辑以及算法.docx";//输入的文件
        String targetFile = "D:\\341000黄山市2020年年度体检报告.pdf";//输出的文件
    ...
    public void modifyWordsJar() {
        try {
            ...
            ClassPool.getDefault().insertClassPath("D:\\aspose-words-23.2-jdk17.jar");
            //获取指定的class文件对象
